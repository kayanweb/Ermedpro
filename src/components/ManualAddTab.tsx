            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
              <div>
                <label className="block text-[11px] font-bold text-slate-700 mb-1 flex items-center gap-1">
                  ...
                  <span>الطبيب المعالج / فاحص الطوارئ (Doctor)</span>
                </label>
                <input
                  type="text"
                  value={doctorName}
                  onChange={e => setDoctorName(e.target.value)}
                  placeholder="مثال: د. مروان البدري"
            ...
            <div className="p-6 space-y-4 text-xs">
              ...
              <div className="flex items-center gap-2 pt-2">
                ...
                <button
                  type="button"
                  onClick={() => setPendingConfirmRecord(null)}
                  className="py-3 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-xl transition flex items-center gap-1.5"
                >
