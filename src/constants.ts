...
export const USERS: User[] = [
  { username: '1', password: '1', name: 'مدير الطوارئ', role: 'Admin', titleAr: 'مسؤول الطوارئ والنظام' },
  { username: 'admin', password: 'admin123', name: 'د. مروان البدري', role: 'Admin', titleAr: 'مدير الطوارئ والنظام' },
  { username: 'doctor', password: 'doctor123', name: 'د. أحمد سليمان', role: 'Doctor', titleAr: 'طبيب طوارئ أول' },
  { username: 'nurse', password: 'nurse123', name: 'م. سارة محمود', role: 'Nurse', titleAr: 'مسؤولة تمريض الطوارئ' },
  { username: 'viewer', password: 'viewer123', name: 'أ. طارق عبد الرحمن', role: 'Viewer', titleAr: 'مراقب الجودة والإحصاء' },
];
